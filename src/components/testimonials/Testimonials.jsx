  ...
  return (
    <div className="w-11/12 mx-auto pb-12">
      ...
      <div className="flex justify-between items-center md:mb-[200px]">
        <button
          className="lg:h-[80px] lg:w-[80px] rounded-full h-12 w-12 bg-[#a7dbe9] text-white flex justify-center items-center hover:bg-[#001bb4] transition ease-in-out delay-150"
          role="button"
        ...
        <button
          className="lg:h-[80px] lg:w-[80px] h-12 w-12 rounded-full bg-[#001bb4] text-white flex justify-center items-center"
          role="button"
